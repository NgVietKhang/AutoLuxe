...
- [x] P11-T1 Chuẩn hóa hệ màu bằng CSS variables cho cả 2 mode.
- [x] P11-T2 Thêm toggle theme trên header và lưu lựa chọn vào LocalStorage.
- [x] P11-T3 Áp dụng theme ngay khi tải trang để tránh nháy màu.
- [x] P11-T4 Kiểm tra contrast cho text/button/card ở cả light và dark.
- [x] P11-T5 Rà soát toàn trang chính để tránh vỡ giao diện khi đổi mode.
...
- [x] P12-T1 Tạo dictionary VI/EN cho các text tĩnh và text trạng thái.
- [x] P12-T2 Tạo module `i18n.js` để đổi text runtime và lưu locale vào LocalStorage.
- [x] P12-T3 Thêm switch ngôn ngữ ở header và đồng bộ trên mọi trang.
- [x] P12-T4 Dịch thông báo động trong JS (toast, validate, loading/error/empty states).
- [x] P12-T5 Bổ sung fallback khi thiếu bản dịch để không vỡ giao diện.
- [x] P12-T6 Kiểm thử chuyển ngôn ngữ trên các luồng chính: catalog, detail, marketplace, checkout, auth.
...
- [x] Có dark mode đồng bộ toàn site.
- [x] Có chuyển đổi ngôn ngữ VI/EN ổn định trên các trang chính.
